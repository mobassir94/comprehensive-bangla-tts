...
try:
  ...
  print("couldn't import TTS synthesizer,trying again!")
#from TTS.utils.synthesizer import Synthesizer
...
isExist = os.path.exists('./arabic_tts')
if not isExist:
...
print("downloading bangla tts weights........")
...
class BigTextToAudio(object):
    ...
    def ar_tts(self,text):
        ...
        try:
            ...
            audio = ar_model.tts(text_buckw = ar_text)
