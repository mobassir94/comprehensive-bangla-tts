# -*- coding: utf-8 -*-
"""Multilingual_(ben+ara)_tts_inference_colab_demo.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/github/mobassir94/comprehensive-bangla-tts/blob/main/mlt_TTS_inference_demo/Multilingual_(ben%2Bara)_tts_inference_colab_demo.ipynb
...
"""#Removing Annoying print statement from inference script"""
...
if(male):
  ...
  test_ckpt = '/content/bangla_tts/bn_vits/male/checkpoint_481500.pth'
...
mytext = df.tafsir_zakariya_text[1]
...
# %%time
# 
# audio=MLT_TTS(df.tafsir_zakariya_text[0],resample_audio_to_out_sample_rate=False)
# sf.write('tafsir_zakaria_demo.wav', audio, 22050)
# Audio(audio, rate=MLT_TTS.sample_rate)

"""# Multilingual Text to Speech quranic tafsir reader"""
    ...
    for i in range(len(df)):
        ...
        if(surah_num not in surah_list):
            ...
            if surah_curr==surah_num:    
                ...
                sf.write(f'./{surah_num}.wav', full_surah_audio, 22050)
            else:
                bn_audio=[]
                bn_audio.append(audio)
